...
config :bathlarp, BathLARPWeb.Endpoint,
  ...
  secret_key_base: "vl8MTI4X2IXWOoA2URQDyZR1UqFLWjuG7+w8PDiUlJpCbuOBKohetMhLnpo3STtT",
  server: false

# In test we don't send emails.
config :bathlarp, BathLARP.Mailer, adapter: Swoosh.Adapters.Test
